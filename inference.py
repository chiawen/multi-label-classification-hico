        ...
        with tf.Session() as sess:
            with slim.queues.QueueRunners(sess):
                ...
                for step in range(int(num_batches)):
                    np_loss, np_accuracy = sess.run([loss, mean_accuracy]) 
                    print('Step {}, loss: {}, accuracy: {}'.format(step, np_loss, np_accuracy))
                    
                    #np_accuracy, np_loss, np_logits, np_predictions, np_images, np_labels = sess.run(

                    #       [mean_accuracy, loss, logits, predictions, images, labels])
                #print('Step {}, loss: {}, accuracy {}'.format(step, np_loss, np_accuracy))            
